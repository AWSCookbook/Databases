...
class CdkAwsCookbook104Stack(core.Stack):
    ...
    def __init__(self, scope: core.Construct, construct_id: str, **kwargs) -> None:
        ...
        rds_instance = rds.DatabaseInstance(
            ...
            vpc=vpc,
            multi_az=False,
            database_name='AWSCookbookRecipe104',
            instance_identifier='awscookbook104db-orig',
