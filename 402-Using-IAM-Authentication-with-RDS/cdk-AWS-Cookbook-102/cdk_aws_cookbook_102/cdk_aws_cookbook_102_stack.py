...
class CdkAwsCookbook102Stack(core.Stack):
    ...
    def __init__(self, scope: core.Construct, construct_id: str, **kwargs) -> None:
        ...
        rds_instance = rds.DatabaseInstance(
            ...
            vpc=vpc,
            database_name='AWSCookbookRecipe102',
            instance_identifier='awscookbookrecipe102',
