...
class CdkAwsCookbook107Stack(core.Stack):
    ...
    def __init__(self, scope: core.Construct, construct_id: str, **kwargs) -> None:
        ...
        source_db_name = 'AWSCookbookRecipe107Source'
        ...
        source_rds_instance = rds.DatabaseInstance(
            ...
            instance_identifier='awscookbook107SourceDb',
        ...
        target_db_name = 'AWSCookbookRecipe107Target'
        ...
        target_rds_instance = rds.DatabaseInstance(
            ...
            instance_identifier='awscookbook107TargetDb',
            delete_automated_backups=True,
            deletion_protection=False,
            # iam_authentication=
            removal_policy=core.RemovalPolicy.DESTROY,
